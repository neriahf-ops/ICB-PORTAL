...
const PAGES = [
  ...
  {id:"programming-rules",title:"Programming Rules",status:"complete",icon:"≡",content:{heading:"Programming Rules",body:"This is the ICB Programming Model. Every client follows the same systematic approach. The session content changes based on the individual — the system never does.\n\nRead this before you build a single workout. Understand it before you modify a single exercise.",sections:[
