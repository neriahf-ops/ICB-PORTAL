...
const PAGES = [
  ...
  {"id":"session-delivery-sop","title":"Session Delivery SOP","status":"complete","icon":"▣","content":{"heading":"Session Delivery SOP","body":"Every ICB session runs on the same framework: the ICB Training Process. The framework is standard, regardless of the practitioner delivering it. What goes inside each stage is individualized to the client in front of you.","sections":[{"label":"Before the Client Arrives","text":"Arrive 20–30 minutes early.\n\nStep 1: Open KILO. Confirm who is coming and their membership type.\n\nStep 2: Open Trainerize for semi-private clients. Review their workout, the Coach Snapshot, and the last session note. Note what the last Reassess showed and what was planned for today. Adjust if needed.\n\nStep 3: Set up the space. Pull all equipment before they arrive. Think through regressions and progressions in case you need to pivot."},{"label":"When the Client Arrives","text":"Greet them by name with energy and professionalism. Have semi-private clients open Trainerize on their phone. Check them into KILO before the session begins. Ask how they're feeling today, and briefly tell them what the session will focus on."},{"label":"During the Session","text":"Every session follows the ICB Training Process:\n\n1. Regulate\n2. Release\n3. Activate\n4. Load\n5. Integrate\n6. Reassess\n\nChoose your session marker and test it at the start. Time in each stage depends on the client's presentation today. A stage can be long, short, or skipped, but only for a reason you can explain.\n\nAlways show AND tell. When quality drops, the set ends. Load comes only when movement quality is solid.\n\nSee the ICB Training Process section for the full framework. Foam rolling standards are under Release."},{"label":"Reading the Coach Snapshot","text":"The Coach Snapshot in Trainerize tells you how a specific client's body moves. Read it before every session. It tells you which lines are dominant, where Release work is likely to be needed, what to prioritize, and what to avoid. See the Anatomy Trains section for the full framework."},{"label":"After the Session","text":"Enter notes in Trainerize within 15 minutes, using the Session Note Format in the ICB Training Process section. Document how they moved, what you adjusted and why, any pain or limitations, and what to focus on next session.\n\nConfirm the next session before the client leaves."}]}},
  {"id":"training-process","title":"ICB Training Process","status":"complete","icon":"◈","content":{"heading":"The ICB Training Process","body":"Regulate → Release → Activate → Load → Integrate → Reassess\n\nThis is how every ICB practitioner organizes a training session. It is a decision-making framework, not a list of exercises every client must do. The six stages keep ICB consistent from practitioner to practitioner. What goes inside each stage is chosen by you, based on the client's assessment, goals, presentation that day, training history, how they respond in the session, and your scope of practice.\n\nThe session follows the client. The client does not follow a template. But every deviation must come from your reasoning, not from randomness. You should always be able to say why you spent time where you did.","image":"/icb-training-process.png","imageAlt":"The ICB Training Process: 1 Regulate, 2 Release, 3 Activate, 4 Load, 5 Integrate, 6 Reassess","sections":[{"label":"Where the Training Process Fits","text":"The assessment sets your starting hypothesis and priorities. The Training Process is how you act on them, session by session.\n\nASSESS → PLAN → REGULATE → RELEASE → ACTIVATE → LOAD → INTEGRATE → REASSESS → DOCUMENT → ADJUST\n\nWhat you learn in Reassess feeds the next session, and over time feeds the formal periodic reassessments. That loop is what separates an ICB program from a collection of random workouts."},{"label":"The Most Important Rule","text":"The six stages are not six boxes that each get equal time.\n\nOne client may need most of the session in Regulate and Release today and almost none next week. An experienced client may move into Load within minutes. Another client may show you during Activate that the planned loading is wrong for today, and you pivot.\n\nA stage can be long, short, or skipped. It can never be skipped or stretched without a reason you could explain to another ICB practitioner.\n\nNever foam roll a client for ten minutes because Release is step 2."},{"label":"Before You Start: Choose Your Session Marker","text":"Reassess only works if you measured something first.\n\nBefore or during Regulate, pick one marker that matters for today's session and test it. It can be a relevant movement, a functional task the client can do without symptoms, a range-of-motion measure, a balance task, a gait characteristic, or a movement pattern from the assessment.\n\nRecord it. You will test the same marker, the same way, in Reassess.\n\n⚑ NERIAH TO DEFINE: the standard menu of ICB session markers and how each one is tested, so every practitioner measures the same way."},{"label":"1 — Regulate","text":"PURPOSE\nPrepare the client to move and to learn. Help them settle into the session.\n\nDECISION QUESTION\nIs this person ready to move and learn effectively right now?\n\nWHAT IT CAN INCLUDE\nBreathing, positioning, sensory input, tempo, low-level movement, or other appropriate strategies that improve readiness.\n\nWHEN IT MAY BE SHORT OR UNNECESSARY\nThe client arrives settled, focused, and moves well in their first low-level movement. Many experienced clients need very little here.\n\nCOMMON MISTAKES\n• Skipping it when the client walks in rushed, stressed, or guarded.\n• Turning it into the same fixed routine for everyone.\n• Talking over it. Regulate needs the client's attention.\n\nPROGRESS / REGRESS\nSpend more time here when readiness is low. Spend less as the client learns to settle themselves.\n\nDOCUMENT\nWhat you used and whether readiness changed.\n\n⚑ NERIAH TO DEFINE: the observable signs ICB uses to judge that a client is “ready.”"},{"label":"2 — Release","text":"PURPOSE\nAddress movement restrictions or areas of excess tension that matter for today, before asking the client to produce more movement or force.\n\nDECISION QUESTION\nWhat, if anything, is limiting the movement we need today?\n\nWHAT IT CAN INCLUDE\nSelf-myofascial techniques, mobility work, positional work, or other non-invasive strategies within your scope.\n\nTHE RULE\nRelease work needs a reason from the assessment, the Coach Snapshot (dominant line), or what the client presents with today. No reason, no release.\n\nFOAM ROLLING STANDARDS\n60–90 seconds per area. Slow and controlled. Encourage slow breathing. Stop if the client tenses or guards. Never roll directly on the spine. Never chase pain. Foam rolling is preparation, not treatment.\n\nWHEN IT MAY BE SHORT OR UNNECESSARY\nNothing is limiting the movement you need today.\n\nCOMMON MISTAKES\n• Rolling everyone because it's step 2.\n• Releasing without checking whether anything changed.\n• Chasing pain.\n• Letting release eat the session.\n\nPROGRESS / REGRESS\nIf a restriction keeps returning, the release work alone isn't solving it. Look at Activate and Load, and revisit the hypothesis.\n\nDOCUMENT\nWhat you released, where, why (which finding), and the response.\n\n⚑ PROFESSIONAL REVIEW: confirm which hands-on techniques, if any, ICB practitioners may use under Alabama law and ICB's insurance. Until confirmed, Release is client-performed only."},{"label":"3 — Activate","text":"PURPOSE\nImprove the client's ability to recruit, coordinate, and control the muscles needed for the movement you're about to ask for.\n\nDECISION QUESTION\nCan the client access and control what we're about to ask them to use?\n\nWHAT IT CAN INCLUDE\nIsolated or low-load activation, motor-control drills, stability work, positional strengthening, movement preparation.\n\nWHEN IT MAY BE SHORT OR UNNECESSARY\nThe client already shows control of the pattern you're about to load.\n\nCOMMON MISTAKES\n• Activation that has nothing to do with today's Load.\n• Too many drills. Activate prepares; it doesn't replace training.\n• Fatiguing the exact muscles you need for Load.\n\nPROGRESS / REGRESS\nControl is consistent → move to Load.\nClient can't feel or control it → reduce complexity, add support to the position, or slow the tempo.\nActivate shows the planned Load is wrong for today → change the plan. That's the framework working, not failing.\n\nDOCUMENT\nWhat you activated, why, and whether control improved."},{"label":"4 — Load","text":"PURPOSE\nAdd appropriate resistance and progressively build strength and capacity.\n\nDECISION QUESTION\nCan the client maintain the desired strategy when meaningful resistance is introduced?\n\nWHAT IT CAN INCLUDE\nBody weight, bands, cables, dumbbells, kettlebells, barbells, machines, carries, or other resistance.\n\nTHE RULE\nThe goal is not to make the exercise harder. Load should reinforce the movement strategy you're building while increasing capacity. When quality drops, the set ends. Load comes only when movement quality is solid.\n\nWHEN IT MAY BE SHORT\nDays when earlier stages show the client isn't ready for meaningful resistance. For many clients, Load is where most of the session goes.\n\nCOMMON MISTAKES\n• Loading because the plan said so.\n• Judging the session by how hard it was.\n• Letting the client compensate to finish reps.\n\nPROGRESS / REGRESS\nProgress when the strategy holds under the current load. Regress by reducing load, range, or tempo demands, or return to Activate.\nPhase-specific loading guidance lives in Programming Rules (four-phase model).\n\nDOCUMENT\nExercise, load, sets and reps, whether the strategy held, and your next-session decision.\n\n⚑ NERIAH TO DEFINE: (1) ICB's criteria for increasing load. (2) ICB's rule for symptoms during loading: what response means continue, modify, or stop. Until defined, follow Red Flags & Escalation and stop any set that provokes pain."},{"label":"5 — Integrate","text":"PURPOSE\nTeach the body to use the capacity you just built in larger, more complete, coordinated movement.\n\nDECISION QUESTION\nCan the client use what we just developed in a more complete movement?\n\nWHAT IT CAN INCLUDE\nLocomotion, gait, carries, multiplanar movement, rotation, athletic movement, compound patterns, or tasks tied to the client's goals.\n\nCHOOSE BY GOAL\nThe integration task should look like the client's real life or sport: stairs, getting up from the floor, carrying groceries, running, their sport.\n\nWHEN IT MAY BE SHORT\nEarly in the process, integration may be a simple, familiar task. It is rarely skipped entirely. Without it, gains stay in the gym.\n\nCOMMON MISTAKES\n• Dropping it because time ran out.\n• Choosing a task beyond the client's balance or capacity.\n• Turning it into conditioning.\n\nPROGRESS / REGRESS\nMore planes, more speed, less support, more complexity as the client shows control. Pull back when the new strategy breaks down.\n\nDOCUMENT\nWhat task, how it connects to the client's goal, and how they performed."},{"label":"6 — Reassess","text":"PURPOSE\nFind out whether what you did changed anything meaningful.\n\nDECISION QUESTION\nDid our intervention produce the response we expected?\n\nHOW\nRe-test the session marker you chose at the start, the same way you tested it the first time.\n\nTHE RULE\nNever assume an intervention worked because the client completed it.\n\nIF YES\nDocument the response. Use it to guide progression.\n\nIF NO\nReconsider the hypothesis. Regress or modify the intervention. Gather more information where appropriate. Do not respond by adding more exercises.\n\nDOCUMENT\nMarker, before and after results, your interpretation, and what changes next session."},{"label":"Session Note Format","text":"Enter within 15 minutes of the session, per ICB documentation standards.\n\nSession marker: ______  Before: ______  After: ______\nRegulate: what / response\nRelease: what / why / response — or “not needed: reason”\nActivate: what / why / response\nLoad: exercise, load, sets × reps / strategy held? Y or N\nIntegrate: task / goal link / performance\nReassess: expected response? Y or N / interpretation\nNext session: progress, hold, or regress — and why\nFlags: pain, symptoms, anything escalated under Red Flags & Escalation\n\nA stage you skipped still gets a line: “Skipped — reason.”"},{"label":"Case Studies — Same Framework, Different Sessions","text":"ILLUSTRATIVE ONLY. These are not real clients. ⚑ NERIAH TO REVIEW, then replace over time with anonymized real ICB cases.\n\nCLIENT A — 62, limited hip extension, low confidence walking\nMarker: a gait characteristic from the assessment.\nRegulate: longer. Settle breathing and position; the client arrives guarded.\nRelease: targeted, only where the assessment points to restriction affecting hip extension.\nActivate: hip extension control in a supported position.\nLoad: modest. A hip extension pattern they can control through the full set.\nIntegrate: walking practice.\nReassess: re-check the gait marker. No change → revisit the hypothesis, don't add exercises.\n\nCLIENT B — 17, healthy runner\nMarker: a running-relevant movement pattern.\nRegulate and Release: brief. Release only if something limits today's movement.\nActivate: brief, tied to the day's strength work.\nLoad: the core of the session.\nIntegrate: running mechanics and athletic movement.\nReassess: re-check the marker.\nNote: clients under 18 need a parent or guardian's signature on the waiver.\n\nCLIENT C — 45, experienced strength client\nMarker: quality of a compound pattern.\nRegulate and Release: about five minutes combined.\nActivate: only what the day's lifts require.\nLoad and Integrate: most of the session.\nReassess: re-check the pattern under the same conditions.\n\nTHE PIVOT\nA planned heavy lower-body day. During Activate the client can't control the pattern and reports discomfort. The practitioner drops the planned Load, follows Red Flags & Escalation, stays in Activate and light Integrate, and documents why. That is a correct session."},{"label":"Knowledge Check","text":"Discuss your answers with a senior practitioner. Every answer should name the decision question you used.\n\n1. A client moves well in the first two minutes and says they feel great. How much time do you spend in Regulate and Release, and why?\n2. You release a restriction and your marker doesn't change. What do you do next?\n3. During Activate, the client can't control the movement you planned to load. What are your options?\n4. Mid-set, the client's form breaks down on rep 6 of 8. What happens?\n5. Time is running short. Which stage do you protect, and why?\n6. Your reassessment shows no change for three sessions in a row. What does that tell you, and who do you talk to?\n7. Write a session note for a session where you skipped Release."},{"label":"Competency Sign-Off","text":"LEARN → OBSERVE → PRACTICE → DEMONSTRATE → APPLY INDEPENDENTLY\n\n1. Learn: read this page and the Anatomy Trains module. Complete the Knowledge Check.\n2. Observe: shadow sessions and identify each stage, the marker, and why time went where it did.\n3. Practice: deliver sessions under supervision.\n4. Demonstrate: deliver supervised sessions with different client presentations. The evaluator confirms each item:\n• Session marker chosen and tested before and after\n• Every stage used or skipped with a stated reason\n• Release and Activate tied to the assessment or today's presentation\n• Load progression decision stated and justified\n• Symptom and escalation rules followed\n• Session note complete, in format, within 15 minutes\n5. Apply independently: signed off by ICB leadership.\n\n⚑ NERIAH TO DEFINE: number of supervised sessions required, the pass standard, who can evaluate, and which Readiness Level this sign-off belongs to."}]}},
      ...
      <div style={{flex:1,overflowY:"auto",display:"flex",flexDirection:"column",background:C.bg}}>
        ...
        {activePage.isCustom ? (
          ...
          <div style={{padding:"48px 56px",maxWidth:"760px"}}>
            ...
            {activePage.content.image&&<div style={{marginBottom:"40px",borderRadius:"4px",overflow:"hidden",border:`1px solid ${C.border}`}}><img src={activePage.content.image} alt={activePage.content.imageAlt||""} style={{width:"100%",display:"block"}}/></div>}
